...
# @Last Modified time: 2022-11-16 16:21:21
...
class Wg_DNS_SD:
    ...
    def register_myself_in_dns(self, dns_service_type, dns_protocol, peer_id,
        ...
        if self.tunnel_charm.model.unit.is_leader():
            ...
            logging.info(f"All ptr Records: {all_ptr_records}")
            new_ptr_records = [
                (x, False)
                for x
                in all_ptr_records
    ...
    def get_other_peers_info(self, total_num_peers, max_waiting_time_secs):
        ...
        while len(wg_peer_keys) < total_num_peers:
            ...
            logger.info(f"I will wait {SLEEP_TIME} seconds before trying to get " +
